...
if (!empty($userData)) {
    ...
    //Valida se o user já fez a review
...
<div id="main-container" class="container-fluid">
    <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <!-- Verifica se habilita o user ou não -->
            ...
            <?php if (count($movieReviews) == 0): ?>
                <div class="empty-list">Ainda não há comentários para este filme!</div>
            <?php endif; ?>
        </div>
    </div>
</div>
