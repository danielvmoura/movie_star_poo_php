...
<div id="main-container" class="container-fluid">
    ...
    <p class="section-description">Adicione ou Atualize as informações dos seus filmes adicionados!</p>
    <div class="col-md-12" id="add-movie-container">
        <a href="<?= $BASE_URL ?>newmovie.php" class="btn card-btn"><strong>+</strong> Adicionar Filme</a>
    </div>
